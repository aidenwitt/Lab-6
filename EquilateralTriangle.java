...
public class EquilateralTriangle extends Polygon
{
	...
	public EquilateralTriangle(String id, double sideLength)
	{
		...
		sideLengths.add(this.sideLength); sideLengths.add(this.sideLength); sideLengths.add(this.sideLength);
	}
	...
	{
		double rootFraction = Math.sqrt(3) / 4.0;
		double sideLengthSqr = sideLengths.get(0) * sideLengths.get(0);
		return rootFraction * sideLengthSqr;
	}
