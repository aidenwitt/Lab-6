...
public class Trapezoid extends Polygon
{
	...
	{
		super(id);
		this.leftSide = leftSide; this.rightSide = rightSide; this.topBase = topBase; this.bottomBase = bottomBase;
		sideLengths.add(leftSide); sideLengths.add(rightSide); sideLengths.add(topBase); sideLengths.add(bottomBase);
	}
